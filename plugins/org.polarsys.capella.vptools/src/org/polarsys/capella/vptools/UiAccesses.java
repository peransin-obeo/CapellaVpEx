...
public class UiAccesses {
     ...
     * @param icon of console (may be null)
    ...
    private static IOConsole createMessageConsole(IConsoleManager mgr, String name, String icon) {
        ...
        mgr.addConsoles(new MessageConsole[] { result });
     ...
     * @throws CoreException if configurations cannot be accessed.
     */
    private static ILaunchConfiguration findLaunchConfiguration(String cfgName) throws CoreException {
    ...
    private static class LaunchTracer implements ILaunchesListener2 {
        ...
        public LaunchTracer(IOConsole output, ILaunch target) {
            ...
            if (target.isTerminated()) {
                launchesTerminated(new ILaunch[] { target });
            }
        }
     ...
     * @param trace console
     * @param monitor of execution
     * @throws CoreException if cannot start
     */
    static void startLaunchConfiguration(ILaunchConfiguration cfg, IOConsole trace, IProgressMonitor monitor) throws CoreException {
     ...
     * @throws CoreException if cannot start
     */
    static void startLaunchConfiguration(String cfgName, IOConsole trace, IProgressMonitor monitor) {
        try {
