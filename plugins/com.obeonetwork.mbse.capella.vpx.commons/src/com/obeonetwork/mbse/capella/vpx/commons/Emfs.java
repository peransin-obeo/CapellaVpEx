 ...
 *******************************************************************************/
package com.obeonetwork.mbse.capella.vpx.commons;
...
public class Emfs {
    ...
    public static <T extends EObject> T eAncestor(EObject it, Class<T> expectedType) {
        // Not provided by EcoreUtil ...
        if (it == null || expectedType.isInstance(it)) {
            return (T) it;
        }
        return eAncestor(it.eContainer(), expectedType);
    }
