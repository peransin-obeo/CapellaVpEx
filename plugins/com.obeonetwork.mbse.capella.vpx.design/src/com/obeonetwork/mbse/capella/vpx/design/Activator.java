...
public class Activator extends AbstractUIPlugin {
    ...
    /** The plug-in ID. */
    public static final String PLUGIN_ID = "com.obeonetwork.mbse.capella.vpx.design";

    /** The Odesign path. */
    public static final String DESIGN_PATH = PLUGIN_ID
        + "/description/CapellaVpEx.odesign";
